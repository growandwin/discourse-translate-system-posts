...
# version: 0.2.0
# authors: Jarek
# url: https://github.com/jarek/discourse-translate-bots
...
after_initialize do
  reloadable_patch do
    ...
    if defined?(DiscourseAi::Translation::PostCandidates)
      DiscourseAi::Translation::PostCandidates.singleton_class.prepend(
        Module.new do
          private
          ...
          def get
            posts =
              Post
                ...
                # USUNIETO: .where("posts.user_id > 0")
                .where.not(raw: [nil, ""])
    ...
    if defined?(DiscourseAi::Translation::TopicCandidates)
      DiscourseAi::Translation::TopicCandidates.singleton_class.prepend(
        Module.new do
          private
          ...
          def get
            topics =
              Topic
                ...
                .where(deleted_at: nil)
                # USUNIETO: .where("topics.user_id > 0")
