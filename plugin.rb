...
after_initialize do
  reloadable_patch do |plugin|
    # Patch 1: PostCandidates
    if defined?(DiscourseAi::Translation::PostCandidates)
      DiscourseAi::Translation::PostCandidates.singleton_class.class_eval do
    ...
    # Patch 2: TopicCandidates
    if defined?(DiscourseAi::Translation::TopicCandidates)
      DiscourseAi::Translation::TopicCandidates.singleton_class.class_eval do
        alias_method :original_get, :get
